...
describe('Test Image Processing Functions', function () {
    it('test api for image not in full folder so throw error', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?filename=notExist&width=150&height=150')];
                case 1:
                    response = _a.sent();
    ...
    it('test api if name parameter is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?width=150&height=150')];
                case 1:
                    response = _a.sent();
    ...
    it('test api if width parameter is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('test api if height parameter is missing', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('test api if every thing wents will and image processed well', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?filename=lol&width=300&height=300')];
                case 1:
                    response = _a.sent();
